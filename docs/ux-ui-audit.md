...
| Cobertura      |     96 | 19 cenários Playwright, 28 varreduras Axe, 19 testes de API/contratos e seed com todos os estados relevantes      |
| **Geral**      | **94** | aprovado                                                                                                          |
...
- `pnpm test`: 16 testes de API e 3 testes de contratos aprovados;
- `pnpm test:e2e`: 19 cenários aprovados em conjunto;
