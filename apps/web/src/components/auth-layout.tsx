          ...
          <div className="mt-14 border-y border-white/15">
            {[
              ...
              <div
                ...
                key={index}
              >
                <span className="font-mono text-xs text-white/70">{index}</span>
                <div>
                  <p className="text-sm font-bold">{label}</p>
                  <p className="mt-0.5 text-xs text-white/75">{detail}</p>
                </div>
                <Icon aria-hidden="true" className="text-white/80" size={22} />
              </div>
            ))}
          </div>
          <p className="mt-8 flex items-center gap-2 text-xs font-semibold text-white/80">
