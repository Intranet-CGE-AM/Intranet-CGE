...
import { requireOneOfPermissions } from "../access/authorize.js";
...
import { VisitError, type VisitService } from "./service.js";
...
export const visitRoutes: FastifyPluginAsync<VisitRoutesOptions> = async (
  app,
  options,
) => {
  ...
  typedApp.get(
    ...
    async (request, reply) => {
      const user = await requireOneOfPermissions(
        request,
        reply,
      ...
      return options.visitService.dashboard();
    },
  );
  ...
  typedApp.get(
    ...
    async (request, reply) => {
      ...
      return options.visitService.list(request.query);
    },
  );
  ...
  typedApp.get(
    ...
    async (request, reply) => {
      const user = await requireOneOfPermissions(
        ...
        reply,
        options.authenticationService,
        ["visits.read", "visits.history", "visits.reports", "visits.manage"],
      );
      ...
      return options.visitService.getById(request.params.id);
    },
  );
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      ...
      const created = await options.visitService.create(
        user.account.id,
        request.body,
      );
      ...
      let confirmationEmails: Awaited<
        ReturnType<typeof options.confirmationService.sendForVisit>
      > = [];

      try {
        confirmationEmails = await options.confirmationService.sendForVisit(
          created.id,
        );

        const sentCount = confirmationEmails.filter(
          (result) => result.sent,
        ).length;

        const failedCount = confirmationEmails.length - sentCount;
        ...
        await recordAudit(options.db, {
          ...
          action: "visit.confirmation-sent",
          ...
          metadata: {
            ...
            attemptedCount: confirmationEmails.length,
  ...
  typedApp.patch(
    ...
    async (request, reply) => {
      ...
      return options.visitService.update(
        request.params.id,
        user.account.id,
        request.body,
      );
  ...
  typedApp.delete(
    ...
    async (request, reply) => {
      ...
      await options.visitService.remove(
        request.params.id,
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      ...
      return options.visitService.approve(
        request.params.id,
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      ...
      return options.visitService.reject(
        request.params.id,
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      ...
      return options.visitService.releaseToReception(
        request.params.id,
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      const user = await requireOneOfPermissions(
        ...
        reply,
        options.authenticationService,
        ["visits.confirmation.manage", "visits.manage"],
      );
      ...
      const visit = await options.visitService.getById(request.params.id);

      try {
        const results = await options.confirmationService.sendForVisit(
          request.params.id,
        );
        ...
        await recordAudit(options.db, {
          ...
          action: "visit.confirmation-resent",
        ...
        return reply.status(502).send({
          code: "VISIT_CONFIRMATION_SEND_FAILED",

          message: "Não foi possível enviar a confirmação ao visitante.",
        });
      }
    },
  );
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      ...
      return options.visitService.startService(
        request.params.id,
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      ...
      return options.visitService.complete(
        request.params.id,
  ...
  typedApp.post(
    ...
    async (request, reply) => {
      ...
      return options.visitService.cancel(
        request.params.id,
...
function safeErrorMessage(cause: unknown) {
  if (cause instanceof Error) {
    const message = cause.message.trim().slice(0, 300);

    return message || "Falha não identificada.";
  }
